		...
		*/
		_newInst: function($input, o) {
			...
			if(typeof(tp_inst._defaults.controlType) === 'string'){
				if(tp_inst._defaults.controlType == 'select' && $.fn.slider === undefined){
		...
		_controls: {
			...
			select: {
				...
				options: function(tp_inst, obj, opts, val){
					...
					// || $t.data('min') Removed by Prasanth Gadde
					return tp_inst.control.create(tp_inst, obj, $t.data('unit'), $t.val(), o.min, o.max || $t.data('max'), o.step || $t.data('step'));
				},
				value: function(tp_inst, obj, val){
