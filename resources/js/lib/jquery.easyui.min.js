...
menu[0].shadow.css({display:"block",zIndex:$.fn.fg_menu.defaults.zIndex++,left:menu.css("left"),top:menu.css("top"),width:menu.outerWidth(),height:menu.outerHeight()});
menu.css("z-index",$.fn.fg_menu.defaults.zIndex++);
if(menu.hasClass("menu-top")){
...
$.fn.fg_menu=function(_361,_362){
if(typeof _361=="string"){
return $.fn.fg_menu.methods[_361](this,_362);
}
_361=_361||{};
return this.each(function(){
...
_363=$.data(this,"menu",{options:$.extend({},$.fn.fg_menu.defaults,$.fn.fg_menu.parseOptions(this),_361)});
init(this);
}
$(this).css({left:_363.options.left,top:_363.options.top});
});
};
$.fn.fg_menu.methods={options:function(jq){
...
$.fn.fg_menu.parseOptions=function(_36b){
return $.extend({},$.parser.parseOptions(_36b,["left","top",{minWidth:"number"}]));
};
$.fn.fg_menu.defaults={zIndex:110000,left:0,top:0,minWidth:120,onShow:function(){
},onHide:function(){
...
$.fn.fg_menubutton=function(_372,_373){
if(typeof _372=="string"){
return $.fn.fg_menubutton.methods[_372](this,_373);
}
_372=_372||{};
return this.each(function(){
...
$.data(this,"menubutton",{options:$.extend({},$.fn.fg_menubutton.defaults,$.fn.fg_menubutton.parseOptions(this),_372)});
$(this).removeAttr("disabled");
}
init(this);
});
};
$.fn.fg_menubutton.methods={options:function(jq){
...
$.fn.fg_menubutton.parseOptions=function(_375){
var t=$(_375);
return $.extend({},$.fn.linkbutton.parseOptions(_375),$.parser.parseOptions(_375,["menu",{plain:"boolean",duration:"number"}]));
};
$.fn.fg_menubutton.defaults=$.extend({},$.fn.linkbutton.defaults,{plain:true,menu:null,duration:100});
})(jQuery);
(function($){
function init(_376){
