...
public class TemplateService extends BaseService {
	...
	@Path("/gatTemplate")
	@UnSecure
	public String getTemplateByName(@Context HttpHeaders headers, @Context UriInfo uriInfo,
	...
	List<Template> templates = (List<Template>) TemplateHandler.getInstance().getTemplateByName(template);
