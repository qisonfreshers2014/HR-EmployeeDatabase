...
public class UploadServletForCKEditor extends HttpServlet {
...
/*            String jsonString = JsonUtil.getJsonBasedOnDescriptor(savedFile, File.class);
            ...
            String html = "<script type=\"text/javascript\"> window.parent.document.getElementById('fileId').innerHTML ="+savedFile.getId()+"; "+ "window.parent.CKEDITOR.tools.callFunction(" + ckeditorFuncNum + ", " + "\"" + savedFile.getFilePath() + "\"" + "); </script>";
            out.println(html);
